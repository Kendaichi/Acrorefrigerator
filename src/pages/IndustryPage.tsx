    ...
    return (
      <Layout>
        <div className="section-padding text-center">
          ...
          <Button asChild><Link to="/industries">View All Industries</Link></Button>
        </div>
      </Layout>
    );
  }
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {industry.relatedIndustries.map((ri, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
              >
                <Link to={`/industries/${ri.slug}`} className="block bg-card rounded-2xl p-8 border border-border shadow-sm group hover:border-primary/20 h-full">
