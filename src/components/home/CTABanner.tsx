      ...
      <ScrollReveal>
        <div className="gradient-cta rounded-2xl md:rounded-3xl p-6 sm:p-10 md:p-16 text-center text-primary-foreground hover-lift">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            <Button asChild size="lg" variant="secondary" className="text-base px-8 font-semibold hover-scale w-full sm:w-auto">
              <Link to="/contact">
                Get a Free Quote <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="text-base px-8 bg-transparent border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground hover-scale w-full sm:w-auto">
