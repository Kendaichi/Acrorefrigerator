        ...
        <div className="container-narrow">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem><BreadcrumbLink asChild><Link to="/brands">Brands</Link></BreadcrumbLink></BreadcrumbItem>
              <BreadcrumbSeparator />
        ...
        <div className="container-narrow">
          <motion.div className="max-w-3xl" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <div className="flex flex-wrap gap-3">
              <Button asChild size="lg"><Link to="/contact-us">Book a {brand.name} Repair <ArrowRight className="w-4 h-4 ml-2" /></Link></Button>
      ...
      <section className="section-padding bg-background">
        <div className="container-narrow grid lg:grid-cols-2 gap-12 items-start">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <Button asChild variant="outline"><Link to="/contact-us">Discuss Your {brand.name} System <ArrowRight className="w-4 h-4 ml-2" /></Link></Button>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {brand.relatedBrands.map((rb, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
              >
                <Link to={`/brands/${rb.slug}`} className="block bg-card rounded-2xl p-8 border border-border shadow-sm group hover:border-primary/20 h-full">
